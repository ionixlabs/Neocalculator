// info_dialog.dart
// Displays an informational dialog with app details, gestures, and credits.
...
/// InfoDialog shows app version, links, and gesture tips.
      ...
      content: Column(
        ...
        children: [
          ...
          ListTile(
            ...
            title: const Text('Made by Ionix Labs'),
          ),
        ],
      ),
      actions: [
