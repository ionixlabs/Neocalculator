...
import 'package:neocalculator/utils/extensions/color_extension.dart';
import 'package:neocalculator/utils/extensions/extensions.dart';
import 'package:neocalculator/utils/extensions/theme_extension.dart';
import 'package:neocalculator/utils/settings_model.dart';
import 'package:neocalculator/widgets/button_radius_dialog.dart';
      ...
      return Scaffold(
        body: ListView(
          ...
          children: [
            ...
            const SizedBox(height: 18.0),// Haptic Feedback setting (commented out)

            NeumorphicButton(
              borderRadius: settings.buttonRadius,
              child: ListTile(
                title: const Text('Haptic Touch'),
                trailing: Switch(
